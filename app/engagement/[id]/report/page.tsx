...
const SECTIONS: Section[] = [
    { id: 'exec', title: 'Executive Summary', content: '', status: 'pending', wordCount: 0 },
    { id: 'findings', title: 'Key Findings', content: '', status: 'pending', wordCount: 0 },
    { id: 'controls', title: 'Internal Controls', content: '', status: 'pending', wordCount: 0 },
]
                            ...
                            const htmlContent = `
                                <html>
                                    ...
                                    <body>
                                        ...
                                        <div class="footer">Generated by Arkashri OS. Immutable seal applies only after backend partner signing is completed.</div>
                                    </body>
                                </html>
                            `
            ...
            <div className="flex gap-5">
                ...
                <div className="flex-1 bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden flex flex-col min-h-[500px]">
                    ...
                    <div className="px-6 py-4 border-t border-gray-50 flex justify-end gap-2 bg-gray-50/30">
                        <button onClick={() => console.log('Save Draft clicked')} className="text-[10px] font-bold border border-gray-200 text-gray-500 px-4 py-2 rounded-lg hover:bg-gray-100 transition-colors uppercase tracking-widest">Save Draft</button>
