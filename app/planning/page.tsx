    ...
    return (
        <AuditShell>
            <div className="mb-8 flex items-start justify-between">
                ...
                <button onClick={() => console.log('New Phase clicked')} className="flex items-center gap-2 bg-[#002776] text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-[#001a54] transition-colors shadow-sm">
